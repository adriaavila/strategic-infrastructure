                ...
                <div className="container mx-auto px-6 max-w-5xl">
                    ...
                    <section className="text-center mb-32 flex flex-col items-center justify-center pt-10">
                        ...
                        <motion.h1
                            ...
                            className="text-5xl md:text-7xl font-bold tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-white/90 to-white/70 light:bg-none light:text-slate-900"
                        >
                            La Historia Detrás
                        </motion.h1>
