            ...
            return (
              ...
              >
                <div className="absolute inset-0">
                  <img src={project.image} alt={project.title} className="w-full h-full object-cover object-top transition-transform duration-700 group-hover:scale-110" loading="lazy" />
                </div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-black/10 light:from-white/85 light:via-white/25 light:to-white/5" />
                ...
                <div className="absolute inset-0 p-6 flex flex-col justify-end">
                  ...
                  <div className="mt-3 flex items-center gap-4 opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
                    ...
                    <Link to={`/proyectos/${project.slug}`} className="inline-flex items-center gap-1.5 text-white/65 text-xs md:text-sm font-medium hover:text-white transition-colors">
                      Leer caso
                    </Link>
                  </div>
                </div>
